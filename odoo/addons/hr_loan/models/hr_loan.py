...
class HrLoan(models.Model):
    ...
    department_id = fields.Many2one('hr.department', readonly=False, required=1,
                                    string="Department", help="Employee")
    employee_id = fields.Many2one('hr.employee', string="Employee", domain="[('department_id','=', department_id)]" , required=True, help="Employee")
